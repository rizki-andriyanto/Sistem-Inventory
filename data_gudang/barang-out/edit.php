...
<div class="col-lg-10">
	...
	$show = mysql_query("SELECT * FROM barang_out WHERE id_barang_out ='$id'");
					 ...
					 <div class="col-lg-6"> 
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             ...
                             <label>Tanggal : </label>
                            <input type="date" name="tgl_out" value="<?php echo $data['tgl_out']; ?>" required class="form-control">
				...
				$pilih['B'].
					...
					echo"</select>";
					 ...
					 ?>
                                ...
                                <input type="text" name="jumlah_out" value="<?php echo $data['jumlah_out']; ?>" required class="form-control">
