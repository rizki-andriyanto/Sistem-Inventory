...
if(isset($_GET['id'])){ 
	...
	$cek = mysql_query("SELECT id_barang_out FROM barang_out WHERE id_barang_out='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM barang_out WHERE id_barang_out='$id'");
