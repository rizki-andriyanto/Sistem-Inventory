...
<form action="marketing.php" method="post" name="postform">
...
<div class="row">
          ...
          echo "<select name='nama_pegawai' required class='form-control'> <option value=0 selected>Pilih Nama Marketing</option>";
          $tampil=mysql_query('SELECT * FROM pegawai WHERE id_jabatan="JAB6"');
          while ($pilih=mysql_fetch_array($tampil)) {
          echo "<option value=$pilih[nama_pegawai]>$pilih[nama_pegawai]</option>";
...
if(isset($_POST['cari'])){
  ...
  if(empty($nama_pegawai) and empty($tanggal_awal) and empty($tanggal_akhir)){
    ...
    ?><i><b>Informasi : </b> Pencarian Barang Berdasarkan Marketing <b><?php echo ucwords($_POST['nama_pegawai']);?></b> dari tanggal <b><?php echo $_POST['tanggal_awal']?></b> sampai dengan tanggal <b><?php echo $_POST['tanggal_akhir']?></b></i><?php
...
WHERE
  barang_out.nama_marketing LIKE '%$nama_pegawai%'
AND barang_out.tgl_out BETWEEN '$tanggal_awal'
AND '$tanggal_akhir'");
    $jumlah=mysql_fetch_array(mysql_query("select sum(jumlah_out) 
      as total from barang_out where barang_out.nama_marketing like '%$nama_pegawai%' and tgl_out between '$tanggal_awal' and '$tanggal_akhir'"));
  }
...
<div class="col-lg-10">
                        ...
                        <div class="panel panel-default">
                            ...
                            <a href="marketing.php"><h3 class="panel-title"><i class="fa fa-edit fa-fw"></i>Cari Data Keluar</h3></a><br>
