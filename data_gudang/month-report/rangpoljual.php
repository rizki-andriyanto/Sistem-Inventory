...
<form action="rangpoljual.php" method="post" name="postform">
...
if(isset($_POST['cari'])){
  ...
  if(empty($rangpoljual) and empty($tanggal_awal) and empty($tanggal_akhir)){
    ...
    ?><i><b>Informasi : </b> Pencarian Barang Berdasarkan <b><?php echo ucwords($_POST['rangpoljual']);?></b> dari tanggal <b><?php echo $_POST['tanggal_awal']?></b> sampai dengan tanggal <b><?php echo $_POST['tanggal_akhir']?></b></i><?php
...
WHERE
  barang_out.rangpoljual LIKE '%$rangpoljual%'
AND barang_out.tgl_out BETWEEN '$tanggal_awal'
AND '$tanggal_akhir'");
    $jumlah=mysql_fetch_array(mysql_query("select sum(jumlah_out) 
      as total from barang_out where barang_out.rangpoljual like '%$rangpoljual%' and tgl_out between '$tanggal_awal' and '$tanggal_akhir'"));
  }
...
<div class="col-lg-10">
                        ...
                        <div class="panel panel-default">
                            ...
                            <a href="rangpoljual.php"><h3 class="panel-title"><i class="fa fa-edit fa-fw"></i>Cari Data Keluar</h3></a><br>
