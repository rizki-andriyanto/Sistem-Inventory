...
<form action="report-out.php" method="post" name="postform">
...
INNER JOIN pegawai ON barang_out.nip = pegawai.nip
WHERE
...
AND '$tanggal_akhir'");
    $jumlah=mysql_fetch_array(mysql_query("select sum(jumlah_out) 
      as total from barang_out where id_barang like '%$id_barang%' and tgl_out between '$tanggal_awal' and '$tanggal_akhir'"));
  }
...
<div class="col-lg-10">
                        ...
                        <div class="panel panel-default">
                            ...
                            <a href="report-out.php"><h3 class="panel-title"><i class="fa fa-edit fa-fw"></i>Cari Data Keluar</h3></a><br>
  ...
  ?>
    <tr>
     ...
     </td><td><?php echo $row['nama_pegawai'];?>
