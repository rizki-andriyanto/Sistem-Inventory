...
if(isset($_GET['id'])){ 
	...
	$cek = mysql_query("SELECT id_barang_in FROM barang_in WHERE id_barang_in='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM barang_in WHERE id_barang_in='$id'");
