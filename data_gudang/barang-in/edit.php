...
<div class="col-lg-10">
	...
	$show = mysql_query("SELECT * FROM barang_in WHERE id_barang_in='$id'");
					 ...
					 <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             ...
                             <label>Tanggal : </label>
                            <input type="date" name="tgl_in" value="<?php echo $data['tgl_in']; ?>" required class="form-control">
				...
				$pilih['B'].
					...
					echo"</select>";
					 ...
					 ?>
                                ...
                                <input type="text" name="jumlah_in" value="<?php echo $data['jumlah_in']; ?>" required class="form-control">
