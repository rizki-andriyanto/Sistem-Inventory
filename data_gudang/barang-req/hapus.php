...
if(isset($_GET['id'])){
	...
	$cek = mysql_query("SELECT id_request FROM barang_request WHERE id_request='$id'") or die(mysql_error());
	...
	if(mysql_num_rows($cek) == 0){
		...
		$del = mysql_query("DELETE FROM barang_request WHERE id_request='$id'");
