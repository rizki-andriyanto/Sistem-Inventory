                    ...
                    <li>
                     <a href="javascript:;" data-toggle="collapse" data-target="#gudang1"><i class="fa fa-fw fa-th"></i> Master <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="gudang1" class="collapse">
                            ...
                            <li>
                                <a href="../barang/index.php"><span class="glyphicon glyphicon-tasks"></span> &nbsp;Data Barang</a>
                            </li>
                             <li>
                                <a href="../kategori-barang/index.php"><span class="glyphicon glyphicon-tags"></span> &nbsp;Kategori</a>
                            </li>
                             
                             <li>
                                <a href="../satuan-barang/index.php"><span class="glyphicon glyphicon-tags"></span> &nbsp;Satuan</a>
                            </li>
                            <li>
                                <a href="../mobil/index.php"><span class="fa fa-fw fa-car"></span> &nbsp;Mobil</a>
                            </li>
